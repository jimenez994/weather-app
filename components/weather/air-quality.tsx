    ...
    <AnimatedContainer delay={0.6}>
      <GlassCard className="p-4 md:p-6">
        <div className="flex items-center gap-2 mb-4">
          <Wind className="w-4 h-4 text-white/65" />
          <p className="text-xs font-medium text-white/55 uppercase tracking-widest">Air Quality</p>
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-white/65 mt-0.5">AQI Index</p>
          </div>
          <div
        ...
        <div className="space-y-2">
          <div>
            <div className="flex justify-between text-xs mb-1">
              ...
              <span className="text-white/75">{pm25.toFixed(1)} µg/m³</span>
            </div>
          ...
          <div>
            <div className="flex justify-between text-xs mb-1">
              ...
              <span className="text-white/75">{pm10.toFixed(1)} µg/m³</span>
            </div>
            <div className="h-1 rounded-full bg-white/10 overflow-hidden">
              <motion.div
                className="h-full rounded-full bg-white/40"
